...
- Специализация - Программирование в инфокоммуникационных системах
- Год выпуска -  2023
```

#### **🧑‍🏫 Educator**
```
- Начал преподавать на 3 курсе собственным одногруппникам
- Сейчас преподаю Проектирование мобильных и сетевых приложений и Разработку интерфейсов
```

#### **🎮 Entrepreneur**
```
- Создатель популярной по всему миру серии игр про коллекционирование карточек футболистов Football Collection
- Занимался мобильным приложением на Flutter, веб-скраппингом данных на Python + Octoparse, дизайном
```

#### **💻 Linuxiod**
```
- Android Phone
- Manjaro Linux for Home
```

### 📫 Контакты
- **Локация:** Санкт-Петербург
- **Email:** churikov.egor@bk.ru
- **GitHub:** [Churikov0112](https://github.com/Churikov0112)
